...
export class LatexRenderDirective {
  ...
  @Input('latexContent') latexContent: string;
  ...
  ngOnInit() {
    ...
    htmlContent = htmlContent.replace(this.centeredLatexExpPattern, (tok: string) => this.renderLatexExpression(tok, this.displayCenterOption));
